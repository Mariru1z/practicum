            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <h5 class="card-header">Información de los profesores</h5>
                            <div class="table-responsive text-nowrap">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>Nombre</th>
                                            <th>Materias que puede impartir</th>
...
// Preparar la consulta SQL para seleccionar los datos de la tabla de profesores
$sql = "SELECT p.id, p.nombre_profesor, 
                (SELECT GROUP_CONCAT(mp.materia SEPARATOR ', ') FROM Materias_Profesores mp WHERE mp.id_profesor = p.id) AS materias_impartidas,
                (SELECT GROUP_CONCAT(CONCAT(dp.dia_semana, ' - ', dp.hora_inicio, ' a ', dp.hora_fin) SEPARATOR '<br>') FROM dias_profesor dp WHERE dp.id_profesor = p.id) AS horarios
        FROM Profesores p";
...
if ($resultado->num_rows > 0) {
    ...
    while ($fila = $resultado->fetch_assoc()) {
        ...
        echo "<td>" . $fila["materias_impartidas"] . "</td>";
        ...
        echo "<a class='dropdown-item' href='" . $_SERVER['PHP_SELF'] . "?eliminar_profesor=" . $fila['id'] . "'><i class='bx bx-trash me-1'></i> Eliminar</a>";
        echo "</div>";
        echo "</div>";
        echo "</td>";
        echo "</tr>";
